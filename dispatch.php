...
//retreive from particular table those patrol car that are 2:Patrol or 3:Free
...
if (isset($_POST["btnDispatch"]))
{
		...
		$patrolcarDispatched = $_POST["chkPatrolcar"]; //array of patrolcarbeing dispatched from post back
		...
		if ($numOfPatrolcarDispatched > 0) {
			...
			$incidentStatus='1'; //incident stsus to be set as Pending
		}
		$sql ="INSERT INTO incident (caller_name, phone_number, incident_type_id,
		incident_location, incident_desc,incident_staus_id) VALUES('".$_POST['callerName']
	...
	$conn->close();
	?>
		<!-- After dispatching, redirect to logical.php-->
	<script type="text/javascript">window.location="./logcall.php";</script>
<?php } ?>
	

	
<!-- display the incident information  passed from logical.php -->
...
<tr>
	<td>Description :</td>
	<td><textarea name="incidentDesc" readonly id="incidentDesc" cols="45" rows"5"><?php echo $_POST['incidentDesc'] ?></textarea>
	<input name="incidentDesc" type="hidden"
	id="incidentDesc" value="<?php echo $_POST['incidentType'] ?>"></td>
</tr>
</table>
