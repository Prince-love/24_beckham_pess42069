...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2021 at 07:00 AM
...
CREATE TABLE `incident` (
  ...
  `incident_status` varchar(1) NOT NULL,
...
INSERT INTO `incident` (`incident_id`, `caller_name`, `phone_number`, `incident_type_id`, `incident_location`, `incident_desc`, `incident_status`, `time_called`) VALUES
(6, 'PETER LEOW', '81234567', '010', 'Junction of North Bridge Rd and Middle Rd', 'A bus collided with a Taxi 2 injuries', '1', '2021-02-25 15:17:02'),
(8, 'qwerty', '12345678', '030', 'cck', 'qwerty', '3', '2021-02-25 15:17:02');
