...
else
{
	...
	//retreive patrol car detail
$sql = "SELECT * FROM patrolcar Where patrolcar_id = '".$_POST['patrolCarId']."'";
$result = $conn->query($sql);

// if the patrol car does not exist, redirect to update.php
if ($result->num_rows == 0) {
	?>
	
		<script typpe="text/javascript">window.location="./update.php";</script>
<?php }
...
$conn->close();
?>
<!-- display a form for operator to update of status of patrol car -->
